                                                ...
                                                <form method="post" action="{{ route('user.address.store') }}" >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <input class="form-control" name="user_id" type="number" readonly hidden value="{{ Auth::user()->id }}" />
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12 mb-20">
                                                            <textarea rows="5" placeholder="Tambahan informasi, Ancer-ancer, RT/RW, No Jalan, Apartement, Per4an/Per3an, dll (Opsional)" name="note"></textarea>
                                                        </div>
