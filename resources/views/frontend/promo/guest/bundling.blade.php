                        ...
                        <div class="product-cart-wrap hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ url('guest/product/details/' . $product->product_slug . '-' . $product->id . '.html') }}"
                                        tabindex="0">
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="{{ url('guest/product/details/' . $product->product_slug . '-' . $product->id . '.html') }}"
        ...
        <div class="product-page2-fourth-sec-wrap">
            ...
            <div class="product-page2-flex">
                ...
                <div class="product-page2-buy-btn">
                    <a href="{{ route('checkout.guest') }}">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
