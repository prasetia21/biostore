                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a
                                        href="{{ url('product/details/' . $product->product_slug . '-' . $product->id . '.html') }}">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div>
                                    @if ($product->vendor_id == null)
                                        <span class="font-small text-muted">By <a href="#">Admin</a></span>
                                    @else
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    @else
                                        <div class="product-price">
                                            ...
                                            <span class="old-price">Rp.{{ $product->selling_price }}</span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="add-cart">
                                        <a class="add"
                                            href="{{ url('product/details/' . $product->product_slug . '-' . $product->id . '.html') }}"><i
            ...
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    ...
                    @foreach ($categories as $category)
                        ...
                        <li>
                            <a
                                href="{{ url('product/category/' . $category->category_slug . '-' . $category->id . '.html') }}">
                ...
                @foreach ($newProduct as $product)
                    <div class="single-post clearfix">
                        ...
                        <div class="content pt-10">
                            <p><a
                                    href="{{ url('product/details/' . $product->product_slug . '-' . $product->id . '.html') }}">{{ $product->product_name }}</a>
                            </p>

                            @if ($product->discount_price == null)
                                <p class="price mb-0 mt-5">Rp.{{ $product->selling_price }}</p>
                            @else
                                <p class="price mb-0 mt-5">Rp.{{ $product->discount_price }}</p>
                            @endif
