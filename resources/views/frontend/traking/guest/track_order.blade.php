...
<div class="container">
    <article class="card">
        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
                    ...
                    <div class="col"> <strong>Shipping BY:</strong> <br> {{ $track->name }} | <i
                            class="fa fa-phone"></i>{{ $track->phone }} / {{ $track->province->name }} /
                        {{ $track->city->name }} </div>

                    <div class="col"> <strong>Payment Method:</strong> <br>{{ $track->payment_method }} </div>

                    <div class="col"> <strong>Total Amount #:</strong> <br>Rp.{{ $track->amount }}</div>
                </div>
            </article>
            <div class="track">
            ...
            <hr>
            <a href="{{ route('user.track.order.guest') }}" class="btn btn-warning" data-abc="true"> <i
