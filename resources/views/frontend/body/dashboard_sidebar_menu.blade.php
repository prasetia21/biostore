...
<ul class="nav flex-column" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link {{ ($route ==  'user.myreward.page')? 'active':  '' }}" href="{{ route('user.myreward.page') }}" ><i class="fi-rs-trophy mr-10"></i>My Reward</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ ($route ==  'user.referral.page')? 'active':  '' }}" href="{{ route('user.referral.page') }}" ><i class="fi-rs-users mr-10"></i>Referall Program</a>
    </li>
