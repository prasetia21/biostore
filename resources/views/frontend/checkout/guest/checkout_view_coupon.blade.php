    ...
    <div class="row">
        <div class="col-lg-12 p-20">
            ...
            <div class="row">
                ...
                <form method="post" action="{{ route('checkout.store.guest') }}">
                    @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="border p-20 cart-totals mb-20 mt-20">
                            ...
                            <div class="order_table checkout">
                                    ...
                                    <tbody>
                                        @foreach ($carts as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="w-160 mb-1">{{ $item->name }}</h6></span>
                                ...
                                <input id="ship_price" type="text" value="" name="shipping_price" hidden
                                    readonly>
                                <input id="ship_expedition" type="text" value="" name="shipping_expedition"
                                    hidden readonly>
                                <input id="ship_service" type="text" value="" name="shipping_service"
                                    hidden readonly>
                                <input id="ship_estimation" type="text" value="" name="shipping_estimation"
                                    hidden readonly>
                                ...
                                <div class="row mt-20">
                                    <div class="col-lg-12">
                                        ...
                                        @else
                                            <div class="p-20" id="couponField">
                                                <p class="mb-20"><span class="font-lg text-muted">Gunakan Kode Promo?
                                                </p>
                                                <form action="#">
                                                    <div class="d-flex justify-content-between">
                                                        <input class="font-medium mr-15 coupon" id="coupon_name"
                                                            placeholder="Enter Your Coupon">
                                                        <a type="submit" onclick="applyCouponFix()"
                                    ...
                                    <div class="col-lg-12 mt-20" id="couponAply">
                                        <div class="divider-2 mb-20"></div>
                                        <div class="border cart-totals">
                                          
                                                <table class="table no-border">
                                                    @if (Session::has('coupon'))
                                                        <tbody id="couponCalField" class="table no-border">
                                ...
                                <hr>
                                <table id="noCouponApply" class="table no-border mt-20">
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount">
                                                    <h4 class="text-brand text-end" id="result-subtotal">Rp. {{$cartTotal}}</h4>
                                                </td>
                                            </tr>
                                ...
                                <table id="noCoupon" class="table no-border">
                                    <tbody>
                                        <tr>
                                            <td class="cart_total_label">
...
<script>
    function displayRadioValue() {
        ...
        const hargaSubTotal = parseInt(intSubHarga[1].substring().replace(/[\.,]0{2}/, '').replaceAll(',', ''));
        ...
        document.getElementById("result-grandtotal").innerHTML = "Rp. " + strGrandTotal + '.00';
