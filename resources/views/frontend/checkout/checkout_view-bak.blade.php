                        ...
                        <div class="row shipping_calculator invisible">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select class="form-control provinsi-tujuan" name="province_destination"
                                        id="provinsi" required>
                                        <option value="{{ !empty($address->raja_province_id) ? $address->raja_province_id : '' }}">{{ !empty($address->raja_province_id) ? $address->raja_province_id : '' }}</option>
                                    </select>
                                </div>
                                <div class="form-group col-lg-12 mt-40">
                                    <label for="kota" class="form-label">Pilih Kota / Kabupaten</label><br />
                                    <select class="form-control kota-tujuan" name="city_destination" id="kota"
                                        required>
                                        <option value="{{ !empty($address->city_id) ? $address->city_id : '' }}">{{ !empty($address->city_id) ? $address->city_id : '' }}</option>
                                    </select>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @if (Session::has('coupon'))
                                            <tr>
                                                ...
                                                <td class="cart_total_amount">
                                                    <h4 class="text-brand text-end" id="result-subtotal">Rp. {{ $cartTotal }}
                    ...
                    if (response) {
                        ...
                        $.each(response[0]['costs'], function(key, value) {
                            $('#ongkir').append(
                                ...
                                'value="' + value.cost[
                                    0].value + ' ' + value.service + ' ' + value.cost[0].etd + '"' +
