                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    >
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>Alamat</td>
                                          <td>:</td>
                                          <td> {{ $order['alamat'] }}, {{ $order['kecamatan'] }}, {{ $order['kota'] }}, {{ $order['provinsi'] }}, {{ $order['kode_pos'] }}</td>
                                        </tr>
                                    ...
                                    >
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td
                                            class="fw-700 text-right border-top"
                                            style="
                                              line-height: 24px;
                                              font-size: 16px;
                                              border-top-width: 1px !important;
                                    ...
                                    >
                                      ...
                                      Customer Care Kami di
                                      <a href="#" style="color: #0d6efd"
                                        ><span
                                          class="__cf_email__"
                                          data-cfemail="531b3a23103c212313362b323e233f367d303c3e"
                                          >info@bioindustries.co.id</span
                                        ></a
                                      >.
                                    </p>
