...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Tambah Coupon </div>
					<div class="ps-3">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('store.coupon') }}"   >
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<h6 class="mb-0">Masa Berlaku Coupon</h6>
		</div>
		<div class="form-group col-sm-9 text-secondary">
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                coupon_name: {
                    required : 'Masukkan Nama Coupon',
                },
                coupon_discount: {
                    required : 'Masukkan Besaran Diskon',
                },
            },
            errorElement : 'span', 
