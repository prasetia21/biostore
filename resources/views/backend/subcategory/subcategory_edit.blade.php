...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Sub-Kategori </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Edit Sub-Kategori </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('update.subcategory') }}"   >
	 	...
	 	<select name="category_id" class="form-select mb-3" aria-label="Default select example">
           ...
           <div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Nama Sub-Kategori</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                subcategory_name: {
                    required : 'Masukkan Nama Sub-Kategori',
                },
            },
            errorElement : 'span', 
