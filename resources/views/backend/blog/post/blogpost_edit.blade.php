...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Postingan Blog </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Edit Postingan Blog </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.blog.post') }}" enctype="multipart/form-data" >
		 ...
		 <div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Kategori Postingan</h6>
				</div>
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Postingan Blog</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
...
<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Deskripsi Singkat Blog</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Deskripsi Lengkap Blog</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
