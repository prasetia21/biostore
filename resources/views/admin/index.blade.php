...
<div class="page-content">
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
							...
							<div class="card radius-10 bg-gradient-orange">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">Rp. {{ $today }}</h5>
									<div class="ms-auto">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">Rp. {{ $month }}</h5>
									<div class="ms-auto">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">Rp. {{ $year }}</h5>
									<div class="ms-auto">
						...
						<div class="col">
							<div class="card radius-10 bg-gradient-burning">
							 <div class="card-body">
								...
								<div class="d-flex align-items-center text-white">
									<p class="mb-0">Orderan Pending</p>
