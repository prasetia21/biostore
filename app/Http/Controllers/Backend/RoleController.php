...
class RoleController extends Controller
{
    ...
    public function StorePermission(Request $request)
    {
        ...
        toastr()->info('Role Perizinan User Baru Berhasil Ditambahkan');
    ...
    public function UpdatePermission(Request $request)
    {
        ...
        toastr()->success('Role Perizinan User Berhasil Diupdate');
    ...
    public function DeletePermission($id)
    {
        ...
        toastr()->success('Role Perizinan User Berhasil Dihapus');
    ...
    public function StoreRoles(Request $request)
    {
        ...
        toastr()->info('Perizinan Berhasil Ditambahkan');
    ...
    public function UpdateRoles(Request $request)
    {
        ...
        toastr()->success('Perizinan Berhasil Diupdate');
    ...
    public function DeleteRoles($id)
    {
        ...
        toastr()->success('Perizinan Berhasil Dihapus');
    ...
    public function RolePermissionStore(Request $request)
    {
        ...
        toastr()->info('Role Perizinan User Berhasil Ditambahkan');
