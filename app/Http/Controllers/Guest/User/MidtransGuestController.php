...
class MidtransGuestController extends Controller
{
    ...
    public function MidtransOrder(Request $request)
    {
        ...
        $order = OrderGuest::create([
            ...
            'currency' => 'Rp',
            'amount' => $total_amount,
            'invoice_no' => 'BIOFAST'.mt_rand(10000000,99999999),
        ...
        $invoice = OrderGuest::findOrFail($order->id);
        ...
        $snapUrl = OrderGuest::where('id', $order->id)->get('pay_url');
    ...
    public function CashOrder(Request $request)
    {
        ...
        $order_id = OrderGuest::insertGetId([
            'guest_id' => $guest->id,
            'raja_province_id' => $request->province,
            'city_id' => $request->city,
            'notes' => $request->notes,
            ...
            'transaction_id' => 'FLS' . '-' . Str::random(5),
            'invoice_no' => 'BIOFAST'.mt_rand(10000000,99999999),
            'order_date' => Carbon::now()->format('d F Y'),
            'order_month' => Carbon::now()->format('F'),
            'order_year' => Carbon::now()->format('Y'),
        ...
        $invoice = OrderGuest::findOrFail($order_id);
    ...
    public function midtransHandler(Request $request)
    {
        ...
        $order = OrderGuest::find($realOrderId);
