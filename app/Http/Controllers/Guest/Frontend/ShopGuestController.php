...
class ShopGuestController extends Controller
{
    public function ShopPage()
    {
        ...
        return view('frontend.product.guest.shop_page', compact('products', 'categories', 'newProduct', 'brands'));
    ...
    public function ShopFilter(Request $request)
    {
        ...
        return redirect()->route('shop.page.guest', $catUrl . $brandUrl . $priceRangeUrl);
